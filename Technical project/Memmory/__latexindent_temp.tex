    ...
    \subsection{Análisis de soluciones al tracking de objetos}
        ...
        \subsubsection {Wifi}
            ...
            \begin{center}
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.3\textwidth]{WifiCounting.jpg}
        ...
        \subsubsection {Bluetooth Low Energy - Beacon}
            ...
            \begin{enumerate}
                ...
                \begin{center}
                    \begin{figure}[h]
                        \centering
                        \includegraphics[width=0.3\textwidth]{tipos_beacon_ibeacon.PNG}
                ...
                \begin{center}
                    \begin{figure}[h]
                        \centering
                        \includegraphics[width=0.3\textwidth]{tipos_beacon_edison.PNG}
    ...
    \subsection{Análisis de soluciones a la subida de datos}
        ...
        \subsubsection {ESP Now}
            ...
            \begin{center}
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.3\textwidth]{espnow.PNG}
...
\section{Planos}
    \subsection{Planos mecánicos}
        ...
        En el anexo de diseño mecánico se especifica con mayor detalle el diseño y el prototipado con impresora
        3D.
        \begin{itemize}
    ...
    \begin{itemize}
        \item{Esquemático del emisor beacon}
            \item{Esquemático del receptor ESP32}
            \item{PCB circuito del emisor beacon}
            \item{PCB circuito del receptor ESP32}
        \end{itemize}}
...
\begin{itemize}
    \item \href{https://www.bluetooth.com/}{hola}
    ...
    \item \href{https://www.boe.es/diario_boe/txt.php?id=BOE-A-2002-694}{BOE 1}
    \item \href{https://www.boe.es/buscar/act.php?id=BOE-A-2014-4950}{BOE 2}
    \item \href{https://www.boe.es/buscar/act.php?id=BOE-A-2014-4950}{BOE 3}
